...
Any proven or suspected malfunction should be traced in a bug report, the latter being an issue in the **Picanteo** [github repository](https://github.com/CNES/picanteo).
...
**Picanteo** classical workflow is :
...
* The usage of the `print()` function is forbidden: use the **Picanteo** internal logger instead.
...
The Merge Request will be merged into master after being reviewed by **Picanteo** steering committee. Only the members of this committee can merge into master.
